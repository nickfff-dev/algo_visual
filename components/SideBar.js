...
const SideBar = () => {
  ...
  const toggleMobileMenu = useCallback(() => {
    ...
    return (
<nav
  className="block fixed z-[50] w-full max-w-screen px-6 lg:py-3  mx-auto dark:bg-white bg-white border shadow-md  border-white/80 bg-opacity-80 backdrop-blur-2xl backdrop-saturate-200">
