...
const Visualiser = () => {
  ...
  console.log(data.length, "array length", arrayCount, "array count")
...
if (pivot == index) {
  ...
  return (
    <div className="w-[40vw] mt-64">
      
      <div className="w-[5vw] flex flex-col justify-center items-start col-auto">
        <h1 className="text-2xl font-bold">Visualiser</h1>
